...
import { Edit2, Lock, Bell, Palette, Clock } from "lucide-react";

export const PROFILE_TABS = [
  { id: "profile", icon: <Edit2 className="w-4 h-4" />, label: "Profile" },
  { id: "account", icon: <Lock className="w-4 h-4" />, label: "Account & Security" },
...
export function ActivityItem({ icon, iconBg, iconColor, title, subtitle, time, badge }) {
  return (
